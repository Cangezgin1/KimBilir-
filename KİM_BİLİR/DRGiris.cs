...
namespace KİM_BİLİR
{
    public partial class DRGiris : Form
    {
        public DRGiris()
        {
            InitializeComponent();
        ...
        private void DRGiris_Load(object sender, EventArgs e)
        {
            axWindowsMediaPlayer1.URL = "DR.mp4";
        ...
        public class KuponluGiris
        {
            ...
            public SqlDataReader KulllanıcıKontrol(TextBox KuponKod)
            {
                ...
                komut.CommandText = "select * from DR where KuponKod='" + KuponKod.Text + "'";
