...
namespace KİM_BİLİR
{
    public partial class DefactoGiris : Form
    {
        public DefactoGiris()
        {
            InitializeComponent();
        ...
        private void DefactoGiris_Load(object sender, EventArgs e)
        {
            axWindowsMediaPlayer1.URL = "DEFACTO.mp4";
        ...
        {
            SqlConnection baglantı = new SqlConnection("Data Source=CAN-DESKTOP;Initial Catalog=KimBilirSon;Integrated Security=True");
            SqlCommand komut;
            SqlDataReader read;
            ...
            public SqlDataReader KulllanıcıKontrol(TextBox KuponKod)
            {
                ...
                komut.CommandText = "select * from Defacto where KuponKod='" + KuponKod.Text + "'";
