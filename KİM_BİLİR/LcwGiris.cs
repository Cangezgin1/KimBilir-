...
namespace KİM_BİLİR
{
    public partial class LcwGiris : Form
    {
        public LcwGiris()
        {
            InitializeComponent();
        ...
        private void LcwGiris_Load(object sender, EventArgs e)
        {
            axWindowsMediaPlayer1.URL = "LCW.mp4";
        ...
        public class KuponluGiris
        {
            ...
            public SqlDataReader KulllanıcıKontrol(TextBox KuponKod)
            {
                ...
                komut.CommandText = "select * from LCW where KuponKod='" + KuponKod.Text + "'";
