...
namespace KİM_BİLİR
{
    public partial class MigrosGiris : Form
    {
        public MigrosGiris()
        {
            InitializeComponent();
        ...
        private void MigrosGiris_Load(object sender, EventArgs e)
        {
            axWindowsMediaPlayer1.URL = "MİGROS.mp4";
        ...
        public class KuponluGiris
        {
            ...
            public SqlDataReader KulllanıcıKontrol(TextBox KuponKod)
            {
                ...
                komut.CommandText = "select * from Migros where KuponKod='" + KuponKod.Text + "'";
